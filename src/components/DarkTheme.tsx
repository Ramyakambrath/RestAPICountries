...
export default function DarkTheme({darkMode,setDarkMode}:Props) {
    ...
    return (
          ...
          <button className='mr-2 focus:outline-none  focus:border-transparent ' onClick={() => setDarkMode(!darkMode)}>
            {darkMode ? (
